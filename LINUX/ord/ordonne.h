...
/*** PROTOTYPES DES FONCTIONS ***/
	...
	long effectuer_Les_ES(BCP *p, _ListeTrnq *Tr, ListeP liste, long _FIN_DERNIER_ES, long _TIMER); //éguillage de l'entrée sortie
	...
	void Ord_Tourniquet(_ListeTrnq *Tr, ListeP liste);   //Algorithme d'ordonnancement
